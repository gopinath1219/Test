...
//3 'Ocean Freight'
CustomKeywords.'fn.ValidateProduct.productType'()
...
WebUI.selectOptionByLabel(findTestObject('MQ/CarrierSearch/Agility Movement Type'), 'CY to CY', false)
...
CustomKeywords.'fn.DragAndDropUnique.portCodesFCL'()
