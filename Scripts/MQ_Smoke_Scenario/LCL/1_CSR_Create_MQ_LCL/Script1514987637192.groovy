...
//3
'Ocean Freight'
WebUI.selectOptionByLabel(findTestObject('MQ/CarrierSearch/Product'), 'Ocean Freight', false)

//4
'LCL (NVOCC)'
WebUI.selectOptionByLabel(findTestObject('MQ/CarrierSearch/ProductType'), 'LCL (NVOCC)', false)

//5
CustomKeywords.'fn.Search.multiple'('OriginPort', 'INMAA,INNSA,INCCU,')

CustomKeywords.'fn.Search.multiple'('DestinationPort', 'DEHAM')

WebUI.selectOptionByLabel(findTestObject('MQ/CarrierSearch/Agility Movement Type'), 'CFS to CFS', false)
...
CustomKeywords.'fn.DragAndDropUnique.portCodesLCL'()
